...
public class ItemHandlerTest {
    ...
    public void getAllItems_FirstApproach() {
        Flux<Item> itemFlux = webTestClient
                .get()
                .uri(ItemConstants.ITEM_ROUTER_MAPPING)
                .exchange()
                .expectStatus().isOk()
    ...
    public void getItemById() {
        webTestClient
                .get()
                .uri(String.format(ItemConstants.ITEM_ROUTER_MAPPING + "/%s", FIFTH_ITEM_ID))
                .exchange()
                .expectStatus().isOk()
                .expectBody()
    ...
    public void getItemById_NotFound() {
        ...
        webTestClient
                .get()
                .uri(String.format(ItemConstants.ITEM_ROUTER_MAPPING + "/%s", notValidId))
                .exchange()
    ...
    public void updateItem_Failed() {
        ...
        webTestClient
                .put()
                .uri(String.format(ItemConstants.ITEM_ROUTER_MAPPING + "/%s", incorrectId))
                .contentType(MediaType.APPLICATION_JSON)
                .body(Mono.just(itemToUpdate), Item.class)
                .exchange()
                .expectStatus().isNotFound();
    ...
    @Test
    public void exceptionFunctionRouter() {
        webTestClient
                .get()
                .uri(ItemConstants.ITEM_ROUTER_MAPPING + "/exception/occurred")
                .exchange()
